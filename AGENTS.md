...
- **报考专业**：`报考专业`
- **初试日期**：`2027-12-19`
- **当前激活辅导风格**：`1. 严格把关·保姆提分型 (Strict & Disciplined)`
- **各科目标矩阵（示例模板）**：

| 科目 | 摸底/基准分 | 目标成绩 | 每日基准投入 | 核心提分盘与策略 |
|---|---|---|---|---|
| **科目一：数学二 (302)** | [摸底] 分 | **110+ 分** | 2.5 小时 (150分) | 攻克必考核心题型，严防超纲，规避计算失误，步骤规范化 |
| **科目二：英语二 (204)** | [摸底] 分 | **65+ 分** | 2.0 小时 (120分) | 搭积木拆解长难句，定位阅读选项逻辑，固化作文功能句模板 |
| **科目三：思想政治理论** | [摸底] 分 | **70+ 分** | 1.0 小时 (60分) | 单选+多选得分盘（38~42分），帽子词秒杀，后期背诵闭环 |
| **科目四：408 计算机学科专业基础** | [待填] 分 | [摸底] 分 | **120-130 分** | 3.0 小时 (180分) | 权威教材体系+历年真题深度解剖，白名单题源抽题门禁 |
