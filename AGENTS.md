...
- **目标院校**：`[你的目标院校，如：XX大学]`
- **报考专业**：`[你的报考专业，如：085400 电子信息 / 081200 计算机等]`
- **初试日期**：`[当年考试日期，通常为 12 月倒数第二周周末]`
- **当前激活辅导风格**：`[1. 严格把关·保姆提分型 / 2. 高效应试·高频秒杀型 / 3. 温和启发·减负鼓励型 / 4. 深度原理·学霸溯源型]`
- **各科目标矩阵（示例模板）**：

| 科目 | 摸底/基准分 | 目标成绩 | 每日基准投入 | 核心提分盘与策略 |
|---|---|---|---|---|
| **科目一：数学** | [待填] 分 | **110+ 分** | 2.5 小时 (150分) | 攻克必考核心题型，严防超纲，规避计算失误，步骤规范化 |
| **科目二：英语** | [待填] 分 | **60-70 分** | 2.0 小时 (120分) | 搭积木拆解长难句，定位阅读选项逻辑，固化作文功能句模板 |
| **科目三：政治** | [待填] 分 | **70+ 分** | 1.0 小时 (60分) | 单选+多选得分盘（38~42分），帽子词秒杀，后期背诵闭环 |
| **科目四：专业课** | [待填] 分 | **120-130 分** | 3.0 小时 (180分) | 权威教材体系+历年真题深度解剖，白名单题源抽题门禁 |
...
1. 🛡️ **严格把关·保姆提分型 (Strict & Disciplined)** [默认推荐]
   - **特点**：以真题阅卷人的严苛视角审视解答。
...
2. **权威书目白名单**：在各科 `AGENTS.md` 中填入你的权威参考书（如数学：李林880/汤家凤1800/历年真题；专业课：指定第X版官方教材）；
3. **本地资料存放**：在各科目录下建立 `参考资料/` 文件夹（已由 `.gitignore` 保护，大体积 PDF 与敏感扫描件绝不会上传 GitHub）；
4. **抽题与作业输入方式**：
   - 方式 A（指定题号）：学员报出题号（如“请考我李林880一元积分学第4题”）；
...
|---|---|---|---|
| **Google Antigravity** | 全能 AI IDE | 直接打开工作区，内置多智能体调度与子任务管理 | ★ 最推荐，原生支持 Agent 路由与记忆写回 |
