...
|---|---|---|---|---|
| **科目一：数学二 (302)** | 待摸底 (零基础) | **110+ 分** | 3.0 小时 | 攻克必考核心题型，严防超纲，规避计算失误，步骤规范化 |
| **科目二：英语二 (204)** | 待摸底 (基础起步) | **65+ 分** | 2.0 小时 | 搭积木拆解长难句，定位阅读选项逻辑，固化作文功能句模板 |
| **科目三：思想政治理论** | 待摸底 (未启动) | **70+ 分** | 1.0 小时 | 单选+多选得分盘（38~42分），帽子词秒杀，后期背诵闭环 |
| **科目四：408 计算机学科专业基础** | 待摸底 (基础起步) | **120-130 分** | 2.5 小时 | 权威教材体系+历年真题深度解剖，白名单题源抽题门禁 |
...
- **手头资料白名单 (AI 严守范围)**:
  - 数学: `[本地资料库已就绪]: 27张宇1000题数一-解析册.pdf, 27张宇1000题数一-试题册.pdf, 题库切片_27张宇1000题数一-试题册_20260907_170317.md`
  - 英语: `[本地资料库已就绪]: 2020年考研英语一.pdf, 2021年考研英语一.pdf, 2022年考研英语一.pdf, 2023年考研英语一.pdf, 2024年考研英语一.pdf, 2025年考研英语一.pdf, 题库切片_2024年考研英语一_20260907_170002.md, 题库切片_2024年考研英语一_20260907_170316.md`
  - 政治: `[本地资料库已就绪]: 2017年考研政治真题.pdf, 2018年考研政治真题.pdf, 2019年考研政治真题.pdf, 2020年考研政治真题.pdf, 2021年考研政治真题.pdf, 2022年考研政治真题.pdf, 2023年考研政治真题.pdf, 2024年考研政治真题.pdf, 2025年考研政治真题.pdf`
  - 专业课: `[本地资料库已就绪]: 2021真题及答案.pdf, 2022真题及答案.pdf, 2023真题及答案.pdf, 2024年目标院校811信号真题.pdf, 题库切片_2025华工811真题精选_20260907_183945.md, 题库切片_2025华工811真题精选_测试卷_20260907_185200.md, 题库切片_2025天工大814真题回忆版_20260908_124606.md, 题库切片_2025天工大814真题回忆版_20260908_125425.md, 题库切片_2025天工大814真题回忆版_20260908_130109.md, 题库切片_2025天工大814真题回忆版_20260908_133051.md, 题库切片_2025天工大814真题回忆版_20260908_133231.md, 题库切片_2025天工大814真题回忆版_20260908_134505.md, 题库切片_2025天工大814真题回忆版_20260908_134607.md, 题库切片_sample_exam_20260907_180040.md`
- **核心薄弱诊断与攻坚防线**:
  - 数学薄弱点: `待首次自测诊断 (从零建立学情雷达)`
  - 英语薄弱点: `待首次自测诊断 (从零建立长难句与题型雷达)`
  - 政治薄弱点: `待首次自测诊断 (从零建立选择题得分盘雷达)`
  - 专业课薄弱点: `待首次自测诊断 (从零建立专业课知识图谱雷达)`
...
2. **本地资料存放（白名单门禁）**：在各科 `参考资料/` 目录下放入你正在使用的实体学习资料（支持 PDF、Word/DOCX、图片 JPG/PNG、Markdown 等，已由 `.gitignore` 保护，绝不上云）；
3. **真实文件出题与防幻觉**：AI 私教严格基于本地「参考资料/」目录下实际存放的文件进行原题抽取与派发，若本地未放置对应资料，严禁 AI 凭空捏造未核验的书籍；
4. **作业提交与分步批改**：学员在草稿纸上独立推演作答，完成后敲字输入或拍照上传解答截图（使用 `/img <路径>`），AI 按步骤给出采分点判定并录入错题队列。
...
| 口令 | 触发动作 | 必读核心依赖 |
|---|---|---|
| `终端中枢` / `导航` / `/menu` | 启动 TUI 终端全景智能中枢 v2.5 | `tools/tui_navigator.py` |
...
| `考纲Diff` / `/fetch` | 对比新旧考纲 AST 变迁与动荡率分析 | `tools/intelligence/syllabus_diff.py` |
| `切片入库` / `/ingest` | 试卷智能切片与标准化题卡入库 | `tools/skills/material_ingestion.py` |
