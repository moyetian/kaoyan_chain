...
- **目标院校**：`示例大学`
- **报考专业**：`085400 电子信息（示例方向）`
- **初试日期**：`2026-12-19` (倒计时约 97 天)
- **当前备考阶段**：`强化题型攻坚阶段`
- **当前激活辅导风格**：`温和启发·减负鼓励型 (Encouraging Mentor)`
- **各科目标矩阵（示例模板）**：

| 科目 | 摸底/基准分 | 目标成绩 | 每日基准投入 | 核心提分盘与策略 |
|---|---|---|---|---|
| **科目一：数学二 (302)** | 零基础 | **110+ 分** | 3.0 小时 | 攻克必考核心题型，严防超纲，规避计算失误，步骤规范化 |
| **科目二：英语二 (204)** | 四级 | **65+ 分** | 2.0 小时 | 搭积木拆解长难句，定位阅读选项逻辑，固化作文功能句模板 |
| **科目三：思想政治理论** | 未启动 | **70+ 分** | 1.0 小时 | 单选+多选得分盘（38~42分），帽子词秒杀，后期背诵闭环 |
| **科目四：8XX 示例专业课** | 零基础 | **120-130 分** | 2.5 小时 | 权威教材体系+历年真题深度解剖，白名单题源抽题门禁 |
...
### 【个性化学情与作息调节机制】 (系统已锁定)
- **每日时间预算**: 每日投入 `6.4 小时` (数学: 3.0h / 英语: 2.0h / 政治: 1.0h / 专业课: 2.5h)
- **每周休整窗口**: `每周日晚 18:00~22:30 放松休整，不安排新题`
- **每月模考复盘**: `每月最后一个周日全天进行全真闭卷模考与全科雷达复盘`
- **手头资料白名单 (AI 严守范围)**:
  - 数学: `暂未放置实体资料（私教严格按【数学】官方考纲出题，严禁虚构书目）`
  - 英语: `暂未放置实体资料（私教严格按【英语】官方考纲出题，严禁虚构书目）`
  - 政治: `暂未放置实体资料（私教严格按【政治】官方考纲出题，严禁虚构书目）`
  - 专业课: `暂未放置实体资料（私教严格按【专业课】官方考纲出题，严禁虚构书目）`
- **核心薄弱诊断与攻坚防线**:
  - 数学薄弱点: `计算差`
  - 英语薄弱点: `长难句读不懂`
  - 政治薄弱点: `多选错`
