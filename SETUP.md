...
### 4.5 目标高校研招与社媒口碑侦察 (`ky scout`)
在确定报考院校或备考择校时，一键扫清信息壁垒：
```bash
# 基础侦察：抓取华科计算机研招官方与知乎/B站/小红书讨论
ky scout 华中科技大学 计算机

# 侦察并落盘归档至 04-专业课/目标院校情报_华中科技大学_计算机.md
ky scout 华中科技大学 计算机 --save

# 侦察并一键将目标高校/专业/自命题代码同步至本地 ky_config.json
ky scout 浙江大学 软件工程 --apply

# 仅搜官方研招信息，忽略社交网络评价
ky scout 清华大学 人工智能 --no-social
```
- **官方招考情报**：研招网与高校研究生院官方简章、专业目录、拟招人数、报录比、自命题初试大纲；
- **民间舆情与避坑**：知乎就读体验、导师口碑、B站高分复习经验、小红书压分与调剂歧视警示；
- **AI 战略研报**：已配置 API Key 时自动输出五维深度研报，未配置时输出高密度结构化卡片与官方直达链接。
