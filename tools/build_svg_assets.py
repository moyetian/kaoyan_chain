...
SVG2 = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 560" width="100%" height="100%">
  ...
  <g transform="translate(40, 80)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="20" y="26" class="sch-name" fill="#60a5fa">【高校 A】示例院校A</text>
  ...
  <g transform="translate(40, 435)">
    ...
    <g transform="translate(20, 16)">
      ...
      <text x="135" y="44" fill="#94a3b8" font-size="11.5">冲刺【示例院校A】具备 15~25 分复试安全缓冲垫，数学(110+)与 408(120+)合计需稳拿 230+ 分基本盘；</text>
